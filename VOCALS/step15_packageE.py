...
# Outputs  : VOCALS_PackageE_main.png   (2x3 - Re/Tau scatter + dRe/dNd panels)
#            VOCALS_PackageE_supp.png   (2x2 - dNd vs f_ad, VZA, Nd_insitu)
...
fig.suptitle(
    'VOCALS-REx 2008 — Package E: Spectral Sensitivity (2.1 µm vs 3.7 µm)\n'
    'Do Both MODIS Channels Tell the Same Physical Story?',
...
fig2.suptitle(
    'VOCALS-REx 2008 — Package E: Supplementary — Spectral Sensitivity Drivers\n'
    'What Controls the 2.1 µm vs 3.7 µm Divergence?',
    color=TXT, fontsize=13, fontweight='bold', y=1.005,
)
plt.tight_layout()
