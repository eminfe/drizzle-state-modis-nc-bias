# =============================================================================
# step05_microphysics.py  -  VOCALS-REx 2008
# =============================================================================
...
if __name__ == "__main__":
    ...
    # bins) can produce non-physical Re >> 50 um. Wood (2012) marine Sc
    # in-situ upper bound is ~50 um. We flag these points as instrument
    # artifacts and set to NaN, preserving the rest of the profile data
    # and downstream median statistics. Cross-campaign symmetry: same
    # threshold for POST/MASE/VOCALS.
    re_max = config.POSTPROC.get("re_max_physical_um", 50.0)
