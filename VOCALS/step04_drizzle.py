# =============================================================================
# step04_drizzle.py  -  VOCALS-REx 2008
# =============================================================================
...
#
# OUTPUTS:
#   - VOCALS_golden_case.csv         (gc with drizzle metrics)
#   - VOCALS_golden_microphysics.csv (gm with drizzle_flag, z_norm)
#   - VOCALS_profile_drizzle.csv     (drizzle classification summary)
#   - VOCALS_profile_vertical.csv    (vertical drizzle metrics summary)
# =============================================================================
...
def _large_bin_start_index(d_large_um, d_mid_um):
    ...
    Used to define 'large drops' for drizzle detection. With VOCALS CIP bins
    at midpoints 15, 30, 45, 60, ..., the first bin with D > 100 um is at
    index 7 (midpoint = 105 um), so all bins from index 7 onward count.
    """
