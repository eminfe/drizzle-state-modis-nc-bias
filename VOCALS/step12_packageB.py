...
# Data     : VOCALS_MODIS_Matches.csv  ->  modis
# Outputs  : outputs/figures/VOCALS_PackageB_main.png
#            outputs/figures/VOCALS_PackageB_geo.png
...
fig.suptitle(
    'VOCALS-REx 2008 — Package B: MODIS Applicability & Match Rate Analysis\n'
    'Which Profiles Have Valid MODIS Retrievals?',
...
fig2.suptitle(
    'VOCALS-REx 2008 — Package B: Geometry & Cloud Top Properties  (MATCHED profiles, colour = regime)',
