...
# Outputs  : outputs/figures/VOCALS_PackageD_main.png
#            outputs/figures/VOCALS_PackageD_supp.png
#            outputs/VOCALS_PackageD_notes.md
...
fig.suptitle(
    'VOCALS-REx 2008 — Package D: Bias Driver Decomposition\n'
    'What Drives the MODIS Nd Overestimation?',
...
fig2.suptitle(
    'VOCALS-REx 2008 — Package D: Supplementary — Outlier Analysis & Subgroup Effects',
    color=TXT, fontsize=13, fontweight='bold', y=1.005,
)
plt.tight_layout()
...
# 7. MARKDOWN NOTES
# ════════════════════════════════════════════════════════════════
md_lines = [f"# VOCALS-REx 2008 — Package D: Bias Driver Notes\n"]
