...
fig.suptitle(
    "VOCALS-REx 2008 — Package G: Vertical Structure and Altitude\n"
    "Is MODIS Nd Bias Related to Cloud Height and Vertical Structure?",
...
fig2.suptitle(
    "VOCALS-REx 2008 — Package G: Supplementary — Additional Vertical Structure Diagnostics",
