...
# Outputs  : VOCALS_PackageF_main.png  (2x3 panels)
#            VOCALS_PackageF_supp.png  (2x2 panels)
# =============================================================================
...
fig.suptitle(
    "VOCALS-REx 2008 — Package F: Assumption Sensitivity Analysis\n"
    "How Sensitive is MODIS Nd Bias to f_ad, k, c_w Choice?",
...
fig2.suptitle(
    "VOCALS-REx 2008 — Package F: Supplementary — Scenario Bias Breakdown\n"
    "Isolating the Effect of Each Parameter",
