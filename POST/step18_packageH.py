...
fig.suptitle(
    f"{config.CAMPAIGN_NAME} {config.CAMPAIGN_YEAR} — Package H: Clean/Polluted Classification and MODIS Nd Bias\n"
...
fig2.suptitle(
    f"{config.CAMPAIGN_NAME} {config.CAMPAIGN_YEAR} — Package H: Supplementary — Clean/Polluted Additional Diagnostics",
