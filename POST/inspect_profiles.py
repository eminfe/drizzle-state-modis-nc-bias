...
#
# Output: outputs/figures/POST_step03_profile_inspection.png
# =============================================================================
...
df_qc["Datetime"]    = pd.to_datetime(df_qc["dt"])
df_pts["Datetime"]   = pd.to_datetime(df_pts["dt"])
...
fig.suptitle(
    f"POST 2008 - step03 Golden Profile Inspection  "
...
# Save
# -----------------------------------------------------------------------------
out_path = config.FIG_DIR / "POST_step03_profile_inspection.png"
