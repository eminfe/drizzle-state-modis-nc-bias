...
# Outputs  : outputs/figures/{CAMPAIGN}_PackageC_main.png
#            outputs/figures/{CAMPAIGN}_PackageC_supp.png
...
fig.suptitle(
    f'{config.CAMPAIGN_NAME} {config.CAMPAIGN_YEAR} — Package C: MODIS vs In-Situ Nd Bias Analysis\n'
    f'How Well Does MODIS Retrieve Cloud Droplet Number Concentration?',
...
fig2.suptitle(
    f'{config.CAMPAIGN_NAME} {config.CAMPAIGN_YEAR} — Package C: Supplementary — Nd Bias Deep Dive\n'
    f'Spectral Differences, Regime Medians & Bias Drivers',
    color=TXT, fontsize=13, fontweight='bold', y=1.02,
)
plt.tight_layout()
