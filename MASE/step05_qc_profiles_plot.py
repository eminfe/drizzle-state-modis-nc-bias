# =============================================================================
# step05_qc_profiles_plot.py  -  MASE 2005
# =============================================================================
# Per-profile QC visualization. Plots all golden profiles on a single
# multi-panel figure for visual inspection of:
#
#   - LWC vertical structure (adiabatic-like vs drizzle-flattened)
#   - Drizzle regime spatial pattern across flights
#   - f_ad super-adiabatic profiles (which ones, why)
#   - Profile shape outliers
#
# OUTPUT:
#   outputs/figures/step05_qc/{CAMPAIGN_NAME}_qc_LWC.png
#   outputs/figures/step05_qc/{CAMPAIGN_NAME}_qc_re_cas.png
#   outputs/figures/step05_qc/{CAMPAIGN_NAME}_qc_re_full.png
#   outputs/figures/step05_qc/{CAMPAIGN_NAME}_qc_Nc.png
#
...
def plot_grid(gm, gc, x_col, x_label, title, out_path,
    ...
    # Legend below the suptitle (clear separation)
    legend_elements = [
    ...
    fig.legend(handles=legend_elements, loc="upper center",
               bbox_to_anchor=(0.5, 0.945), ncol=5, fontsize=9, frameon=False)
