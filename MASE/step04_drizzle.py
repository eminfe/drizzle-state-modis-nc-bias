...
#           drizzle_flag  = (drizzle_ratio > lwc_ratio_thresh) AND
#                           (N_large > n_large_thresh)
#           Thresholds come from config.DRIZZLE; MASE uses n_large=1 L^-1
#           (POST/VOCALS use 10 L^-1 — coarser 10 s averaging needs looser cut).
#
#     2b) PROFILE-LEVEL (gc):
...
#
# OUTPUTS:
#   - MASE_golden_case.csv         (gc with drizzle metrics)
#   - MASE_golden_microphysics.csv (gm with drizzle_flag, z_norm)
#   - MASE_profile_drizzle.csv     (drizzle classification summary)
#   - MASE_profile_vertical.csv    (vertical drizzle metrics summary)
# =============================================================================
